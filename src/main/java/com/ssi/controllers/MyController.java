...
@RequestMapping("showexpiry")
public ModelAndView showEpiryProducts(@RequestParam("expdate") String expdate) {
	List<Product> products=productDAO.getExpiryAfter(expdate);
	ModelAndView mv=new ModelAndView("expirylist");
	mv.addObject("products",products);
	mv.addObject("edate",expdate);
	return mv;
}
@RequestMapping("expirysearch")
public String showExpirySearch() {
	return "expirysearch";
}
